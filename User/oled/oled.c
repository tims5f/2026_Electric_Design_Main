...
{  
  unsigned char i,n;  
	for(i=0;i<8;i++)for(n=29;n<128;n++)OLED_GRAM[n][i]=0X00;  
	OLED_Refresh_Gram();//更新显示
...
//  //OLED_ShowString(0, 0, vm, 12);
////  for (int k=0;k<128;k+=2){
////    OLED_DrawPoint(k,12,1);
////  }
//  for(int k=13 ; k<64;k++){
//    OLED_DrawPoint(28,k,1);
//  }
//  for(int k=28 ; k<127;k++){
//    OLED_DrawPoint(k,63,1);
//  }
//  for(int k=22;k<28;k+=2){
//    OLED_DrawPoint(k,15,1);
//  }
//  for(int k=22;k<28;k+=2){
//    OLED_DrawPoint(k,31,1);
//  }
//  for(int k=22;k<28;k+=2){
//    OLED_DrawPoint(k,47,1);
//  }
//}
...
//    {
//    case 0:
//      show_one_decimal(0, 13,3.0, 12);
//      show_one_decimal(0, 29,2.0, 12);
//      show_one_decimal(0, 45,1.0, 12);
//      adc_show_data = 3723;
//      break;
//    case 1:
//      show_one_decimal(0, 13,2.0, 12);
//      show_one_decimal(0, 29,1.3, 12);
//      show_one_decimal(0, 45,0.6, 12);
//      adc_show_data = 2482;
//      break;
//    case 2:
//      show_one_decimal(0, 13,1.5, 12);
//      show_one_decimal(0, 29,1.0, 12);
//      show_one_decimal(0, 45,0.5, 12);
//      adc_show_data = 1861;
//      break;
//    }
//}
